...
checks=(
	...
	"res://tests/town_world_save_test.gd|TOWN_WORLD_SAVE_PASS|193"
	...
	"res://tests/session_save_continue_roundtrip_test.gd|SESSION_SAVE_CONTINUE_ROUNDTRIP_PASS|126"
	...
	"res://tests/offline_resident_model_assignment_page_test.gd|OFFLINE_RESIDENT_MODEL_ASSIGNMENT_PAGE_PASS|130"
	"res://tests/offline_resident_model_rebind_load_page_test.gd|OFFLINE_RESIDENT_MODEL_REBIND_LOAD_PAGE_PASS|145"
